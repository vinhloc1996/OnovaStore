    ...
    public partial class InitDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AnonymousCustomerCartID = table.Column<string>(nullable: false),
                    ...
                    ShippingFee = table.Column<double>(nullable: true, defaultValueSql: "((0))"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnonymousCustomerCart", x => x.AnonymousCustomerCartID);
                    table.ForeignKey(
                        name: "FK_AnonymousCustomerCart_AnonymousCustomerCartID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CustomerCartID = table.Column<string>(nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime", nullable: false),
                    DisplayPrice = table.Column<double>(nullable: true, defaultValueSql: "((0))"),
                    LastUpdate = table.Column<byte[]>(rowVersion: true, nullable: false),
                    PriceDiscount = table.Column<double>(nullable: true, defaultValueSql: "((0))"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerCart", x => x.CustomerCartID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddressLine1 = table.Column<string>(maxLength: 255, nullable: false),
                    AddressLine2 = table.Column<string>(maxLength: 255, nullable: true),
                    CartID = table.Column<string>(maxLength: 450, nullable: true),
                    City = table.Column<string>(maxLength: 100, nullable: false),
                    DisplayPrice = table.Column<double>(nullable: true, defaultValueSql: "((0))"),
                    EstimateShippingDate = table.Column<DateTime>(type: "date", nullable: false),
                    FullName = table.Column<string>(maxLength: 256, nullable: true),
                    InvoiceTokenId = table.Column<string>(unicode: false, maxLength: 250, nullable: false),
                    OrderDate = table.Column<DateTime>(type: "datetime", nullable: false),
                    OrderStatusID = table.Column<int>(nullable: true),
                    OrderTrackingNumber = table.Column<string>(unicode: false, maxLength: 20, nullable: true),
                    PaymentStatus = table.Column<string>(unicode: false, maxLength: 100, nullable: false),
                    PaymentTokenId = table.Column<string>(unicode: false, maxLength: 250, nullable: false),
                    Phone = table.Column<string>(unicode: false, maxLength: 20, nullable: false),
                    PriceDiscount = table.Column<double>(nullable: true, defaultValueSql: "((0))"),
                    PromotionID = table.Column<int>(nullable: true),
                    ShippingFee = table.Column<double>(nullable: true, defaultValueSql: "((0))"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderDetail_PromotionID",
                        column: x => x.PromotionID,
                        principalTable: "Promotion",
                        principalColumn: "PromotionID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Order__02983D835064F442",
                table: "Order",
                column: "OrderTrackingNumber",
                unique: true,
                filter: "[OrderTrackingNumber] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__ProductS__6A7B44FC27401866",
                table: "ProductStatus",
                column: "StatusCode",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Promotio__A617E4B6943E9D2E",
                table: "Promotion",
